    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressDialog.show();
//                user.child("User").addChildEventListener(new ChildEventListener() {
//                    @Override
...
//                });
                ...
                user.child("User").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                      User user_nv = dataSnapshot.child(txtUser.getText().toString()).getValue(User.class);

                            if(dataSnapshot.child(txtUser.getText().toString()).exists())
                            {
                                if(txtUser.getText().toString().equals(user_nv.getLoginname()) && txtPass.getText().toString().equals(user_nv.getPassword()) )
                                {
